...
use zaboy\res\Middleware\StoreMiddlewareMemory;
 ...
 */
class StoreMiddlewareMemoryTest extends \PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        $this->object = new StoreMiddlewareMemory();
    ...
    public function testStoreMiddlewareMemory__invoke() {
        ...
        $this->assertSame(
                get_class($returnedResponse->getAttribute('memoryStore')),
